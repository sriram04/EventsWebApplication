...
<h1 style="color:purple; padding:10px; margin:50px; text-align:center; font-family:algerian; font-size:50px; text-indent:0px;">Hi <?php echo $un?>, Welcome to Our Website</h1>
...
<ul>
  ...
  <li><a href="admin.html?username=<?php echo($un); ?>&pass=<?php echo($p); ?>">Add Events</a></li>
